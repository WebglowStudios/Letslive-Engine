...
async function seedStaff() {
  ...
  const existing = await User.findOne({ email: 'bhushanthakare89@gmail.com' });
  if (existing) {
    console.log('User bhushanthakare89@gmail.com already exists. Skipping.');
  ...
  console.log(`   Email:    bhushanthakare89@gmail.com`);
