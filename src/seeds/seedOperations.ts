...
async function seed() {
  ...
  await OperationTransport.create({ operation: op1._id, vendorName: 'Desert Wheels Tourism', vendorCost: 35000, sellingPrice: 48000, paymentStatus: 'paid', remarks: 'Toyota Fortuner | DW-2026-441 | Driver: Mohammed Ali +971 50 123 4567', legs: [{ from: 'Airport', to: 'Hotels + City Tours', tripDay: 'Day 1-8', vehicleType: 'car', notes: 'DXB-A-54321 | Full 8 days' }] });
  ...
  await OperationTransport.create({ operation: op2._id, vendorName: 'Bali Private Tours', vendorCost: 14000, sellingPrice: 20000, paymentStatus: 'pending', remarks: 'Toyota Avanza | BPT-2026-88 | Driver: Wayan Sudarta +62 812 3456 7890', legs: [{ from: 'Airport', to: 'Ubud + Nusa Dua + Temple tours', tripDay: 'Day 1-7', vehicleType: 'car', notes: 'BA 1234 XY | Full 7 days (10hrs/day)' }] });
