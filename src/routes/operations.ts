...
import {
  getOperations, getOperationById, createOperation, updateOperation, deleteOperation, groupServices, ungroupServices, recalculateOperation, importFromItinerary,
...
router.post('/:id/group', groupServices);
